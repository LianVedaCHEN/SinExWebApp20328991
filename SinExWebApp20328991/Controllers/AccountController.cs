...
namespace SinExWebApp20328991.Controllers
{
    ...
    public class AccountController : Controller
    {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (roleResult.Succeeded)
                    {
                        ...
                        if (model.PersonalInformation != null)
                        {
                            ...
                            db.ShippingAccount.Add(model.PersonalInformation);
                        }
                        else
                        {
                            model.BusinessInformation.UserName = user.UserName;
                            db.ShippingAccount.Add(model.BusinessInformation);
                        }
                        db.SaveChanges();
        ...
        public ActionResult UpdateInfo()
        {
            ...
            var tempType = db.ShippingAccount.SingleOrDefault(s => s.UserName == tempUserName);
            if(tempType is PersonalShippingAccount)
            {
